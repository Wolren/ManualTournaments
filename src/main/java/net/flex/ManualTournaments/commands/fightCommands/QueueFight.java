...
public class QueueFight implements FightType {
    ...
    public void startFight(Player player, List<Player> fighters) {
        try {
            ...
            getPlugin().getLogger().log(Level.SEVERE, "Failed to start queue fight", e);
    ...
    private void setupFighter(List<Player> fighters) {
        ...
        for (Player fighter : fighters) {
            try {
                ...
                getPlugin().getLogger().log(Level.SEVERE, "Failed to setup queue fighter " + fighter.getName(), e);
            }
        }
    }
    ...
    public void stopFight() {
        try {
            ...
            getPlugin().getLogger().log(Level.SEVERE, "Error stopping queue fight", e);
        }
    }
    ...
    private void setFightsFolder() {
        try {
            ...
            getPlugin().getLogger().log(Level.SEVERE, "Failed to create fights folder config", e);
        }
    }
}
